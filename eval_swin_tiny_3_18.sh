...
checkpoint=${3:-"None"}
results_dir=${4:-"/input_oe_data/jieyuz/weikaih/code/mm_grounding_dino_results/eval_results"}
...
CONFIGS=(
#   "/input_oe_data/jieyuz/weikaih/code/mmdetection/configs/mm_grounding_dino/lvis/grounding_dino_swin-t_pretrain_zeroshot_mini-lvis.py"
#   "/input_oe_data/jieyuz/weikaih/code/mmdetection/configs/mm_grounding_dino/odinw/grounding_dino_swin-t_pretrain_odinw35.py"
#   "/input_oe_data/jieyuz/weikaih/code/mmdetection/configs/mm_grounding_dino/refcoco/grounding_dino_swin-t_pretrain_zeroshot_refexp.py"
)

# Change to the mmdetection directory
cd /input_oe_data/jieyuz/weikaih/code/mmdetection || exit 1
...
for config_path in "${CONFIGS[@]}"; do
    ...
    # Run evaluation using the single-GPU test script.
    # If your MMDetection version supports distributed testing and you prefer that,
    # you can replace the following command with a call to ./tools/dist_test.sh.

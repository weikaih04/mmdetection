...
OUTPUT_DIR=/input_oe_data/jieyuz/weikaih/code/mm_grounding_dino_results/${exp_name}
...
./tools/dist_test.sh ${config_path} ${pretrained_weights} ${n} --cfg-options work_dir=${OUTPUT_DIR}

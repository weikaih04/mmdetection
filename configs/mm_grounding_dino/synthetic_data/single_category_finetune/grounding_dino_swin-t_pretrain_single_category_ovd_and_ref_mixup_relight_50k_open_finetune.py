_base_ = 'grounding_dino_swin-t_pretrain_single_category_base.py'
...
ovd_category_train_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        # change this
        label_map_file='data/ovd_single_category/annotations/panoptic_train_50000_label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
ovd_single_category_dataset = dict(
    type='ODVGDataset',
    data_root='data/ovd_single_category/',
...
ovd_single_phrase_dataset = dict(
    type='ODVGDataset',
    data_root='data/ovd_single_category/',
...
ref_category_train_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        # change this
        label_map_file='data/ref_single_category/annotations/panoptic_train_50000_label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
ref_single_category_dataset = dict(
    type='ODVGDataset',
    data_root='data/ref_single_category/',
    ann_file='annotations/panoptic_train_50000_odvg_category.json',
    label_map_file='annotations/panoptic_train_50000_label_map.json',
    data_prefix=dict(img='train/'),
    filter_cfg=dict(filter_empty_gt=True),
...
ref_single_phrase_dataset = dict(
    type='ODVGDataset',
    data_root='data/ref_single_category/',
    ann_file='annotations/panoptic_train_500000_odvg_phrase_grounding.json',
    label_map_file=None,
...
combined_dataset = dict(
    type='ConcatDataset',
    datasets=[ovd_single_category_dataset, ovd_single_phrase_dataset, ref_single_category_dataset, ref_single_phrase_dataset, flickr30k_dataset, obj365_dataset, gqa_dataset]
)

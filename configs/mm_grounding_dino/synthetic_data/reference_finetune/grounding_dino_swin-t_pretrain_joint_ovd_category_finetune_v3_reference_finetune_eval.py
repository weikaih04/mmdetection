_base_ = 'grounding_dino_swin-t_pretrain_reference_base.py'
...
ovd_category_train_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        # change this
        label_map_file='data/ovd/annotations/label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
combined_dataset = dict(
    type='ConcatDataset',
    datasets=[flickr30k_dataset, obj365_dataset, gqa_dataset]
)

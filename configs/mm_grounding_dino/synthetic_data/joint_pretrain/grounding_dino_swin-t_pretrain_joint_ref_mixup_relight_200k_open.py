...
ovd_category_train_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        # change this
        label_map_file='data/ovd/annotations/panoptic_train_200000_label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
ovd_category_dataset = dict(
    type='ODVGDataset',
    data_root='data/ovd/',
    ann_file='annotations/panoptic_train_200000_odvg_category.json',
    label_map_file='annotations/panoptic_train_200000_label_map.json',
    data_prefix=dict(img='train/'),
...
ovd_phrase_dataset = dict(
    type='ODVGDataset',
    data_root='data/ovd/',
    ann_file='annotations/panoptic_train_200000_odvg_phrase_grounding.json',
    label_map_file=None,
    data_prefix=dict(img='train/'),
    filter_cfg=dict(filter_empty_gt=True),
...
ref_category_train_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        # change this
        label_map_file='data/ref/annotations/panoptic_train_200000_label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
combined_dataset = dict(
    type='ConcatDataset',
    datasets=[ref_category_dataset, ref_phrase_dataset, flickr30k_dataset, obj365_dataset, gqa_dataset]
)
